...
@router.post("/product/add", tags=['product'], status_code=201, dependencies=[Depends(jwtBearer())])
...
@router.patch("/product/update/{product_id}", tags=['product'], status_code=201, dependencies=[Depends(jwtBearer())])
...
@router.delete("/product/delete/{product_id}", tags=['product'], status_code=201, dependencies=[Depends(jwtBearer())])
